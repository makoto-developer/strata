...
このプロジェクトは [Contributor Covenant](https://www.contributor-covenant.org/) v2.1 を採用しています。
**日本語版が正**で、英語版(原文)は参考として併記します。

違反の報告先: **makoto-developer@makoto-developer.net**
...
虐待的、嫌がらせ、またはその他の許容できない行動の事例は、執行を担当するコミュニティリーダーに対してmakoto-developer@makoto-developer.netで報告される場合があります。すべての苦情は迅速かつ公正にレビューおよび調査されます。
...
<details>
<summary>English (original text)</summary>
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at makoto-developer@makoto-developer.net. All complaints will be reviewed and investigated promptly and fairly.
